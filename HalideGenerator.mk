...
# -- foo.stub.h (the Stub header file)
...
# These are the variables you *may* define to customize your build
...
# Generator name to use (empty = use stem name)
GENERATOR_GENERATOR_NAME ?= $(notdir $*)
...
$(GENERATOR_FILTERS_DIR)/%.stub.h: $(GENERATOR_BIN_DIR)/%.generator
	@mkdir -p $(@D)
	$< -n $* -o $(GENERATOR_FILTERS_DIR) -e cpp_stub -g "$(GENERATOR_GENERATOR_NAME)"
