...
$(FILTERS_DIR)/cxx_mangling_gpu.a: GENERATOR_GENERATOR_NAME=cxx_mangling
...
# memory_profiler_mandelbrot needs profile enabled
$(FILTERS_DIR)/memory_profiler_mandelbrot.a: GENERATOR_EXTRA_FEATURES=profile

# metadata_tester_ucon uses the same Generator as metadata_tester, with different target features
$(FILTERS_DIR)/metadata_tester_ucon.a: GENERATOR_GENERATOR_NAME=metadata_tester
...
$(BUILD_DIR)/stubuser_generator.o: GENERATOR_GENERATOR_NAME=stubtest
